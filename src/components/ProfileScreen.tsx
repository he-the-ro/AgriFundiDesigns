      ...
      <div className="relative z-10 flex flex-col size-full">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
          ...
          <p className="text-muted-foreground text-center mb-6 max-w-sm">
            We're building a comprehensive profile section with:
          </p>
          ...
          <div className="w-full max-w-sm space-y-3 mb-8">
            <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/50">
              ...
              <div className="flex-1">
                <h4 className="text-foreground text-sm mb-1">Personal Information</h4>
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/50">
              ...
              <div className="flex-1">
                <h4 className="text-foreground text-sm mb-1">Performance Stats</h4>
                <p className="text-xs text-muted-foreground">Track your work statistics and achievements</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/50">
              ...
              <div className="flex-1">
                <h4 className="text-foreground text-sm mb-1">App Settings</h4>
                <p className="text-xs text-muted-foreground">Customize your AgriFundi experience</p>
              </div>
            </div>
          </div>
